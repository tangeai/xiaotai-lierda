...
> 文档基线：2026-09-07；2026-09-11 按当前代码补全 GROUP 多人对讲及交接边界，独立流程见第 17A 章，构建和验证说明见[应用说明](../README.md#当前固件与验证)。2026-09-14 同步公共 JSON 深度保护、F6D_A 任务创建失败适配、当前日志配置和内存预算。
...
具体包和验收项见[应用说明](../README.md#当前固件与验证)。
