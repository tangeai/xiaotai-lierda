...
> 本文解释“应用在哪里调用 SDK、传什么、等什么回调、完成什么功能”。2026-09-11 按当前代码补全 GROUP：`demo_tirtc_whip_connect` → `0x2200 join_room` → stream 1 G.711A → managed disconnect/release；接口及生命周期见第 9A 章，构建与验证见[应用说明](应用说明.md#当前固件与验证)。
