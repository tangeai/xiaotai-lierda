...
static void profile_create(lv_obj_t * parent)
{
    ...
    // lv_obj_set_style_text_font(name, &SourceHanSansCNLight, 0);
    lv_label_set_text(name, "掌握测试");
...
void shop_create(lv_obj_t * parent)
{
    ...
    // lv_obj_set_style_text_font(title, &SourceHanSansCNLight, 0);
    lv_label_set_text(title, "月度总结");
    lv_obj_add_style(title, &style_title, 0);
